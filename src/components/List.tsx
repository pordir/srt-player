...
const EXAMPLES: Example[] = [
  {
    ...
    videoUrl: 'https://pordir.github.io/srt-example/example.mp4',
    subtitleUrl: 'https://pordir.github.io/srt-example/example.srt',
  },
  {
    name: 'Substitute Teacher - Key & Peele.mp4',
    videoUrl: 'https://pordir.github.io/srt-example/example-2.mp4',
    subtitleUrl: 'https://pordir.github.io/srt-example/example-2.srt',
  },
  {
    name: 'アニメそんなもの読んじゃいけません.mp4',
    videoUrl: 'https://pordir.github.io/srt-example/example-3.mp4',
    subtitleUrl: 'https://pordir.github.io/srt-example/example-3.srt',
  },
]
